            ...
            <div class="row">
              <div class="col-sm-12">
                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                    <thead>
                    <tr><th rowspan="1" colspan="1">ID Kamera</th>
                      <th rowspan="1" colspan="1">ID Pemilik</th>
                      <th rowspan="1" colspan="1">Merk Kamera</th>
                      <th rowspan="1" colspan="1">Seri Kamera</th>
                      <th rowspan="1" colspan="1">Spesifikasi Kamera</th>
                      <th rowspan="1" colspan="1">Kondisi Kamera</th>
                      <th rowspan="1" colspan="1">Harga Sewa Kamera</th>
                      <th rowspan="1" colspan="1">Gambar Kamera</th>
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td><?php echo $rows['merek_kamera']?></td>
